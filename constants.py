#####################################################################
### THESE CONSTANTS DEFINE OUR APP/MAP SIZES AND MAP DISPLAY FEATURES
#####################################################################
...
#####################################################################
### THESE CONSTANTS DEFINE HOW THE GALAXY FORMS
#####################################################################
galaxy_seed = 0
# use this fixed seed
# set to 0 to create a random seed
...
#####################################################################
### ADDITONAL (DERIVED) CONSTANTS
#####################################################################
physical_galaxy_scale = galaxy_size // map_size
# typically 100 ly / pixel

galaxy_zoom_factor = arm_scale * display_height
# internal measurement of galaxy size as a function of scale

core_radius = core_radius_percent * galaxy_zoom_factor / 100
